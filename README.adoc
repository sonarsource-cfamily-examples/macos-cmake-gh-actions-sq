...
*This project is analysed on https://next.sonarqube.com/sonarqube/dashboard?id=sonarsource-cfamily-examples_macos-cmake-gh-actions-sq_AYAYs22XMi_-8diYBjH_[SonarQube Server]!*
